...
class Move
  ...
  VALUES = ['rock', 'paper', 'lizard', 'scissors', 'spock']

  def initialize(value)
    @value = value
  end

  def self.return_move(string)
    eval "#{string.capitalize}.new"
  end
...
class Human < Player
  ...
  def choose
    ...
    self.move = Move.return_move(choice) #Move.new(choice)
  end
end
...
class Computer < Player
  ...
  def choose
    self.move = Move.return_move(Move::VALUES.sample)
  end
end
