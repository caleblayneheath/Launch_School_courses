...
// create containers for used positive/negative words
// split text into an array of words
// for each word, see if positive/negative/neutral
//   if pos/neg add to container
// decide if text positive/negative/neutral by counting array length
// output result, message, and banks of used positive and negative words
...
//   });
  ...
  let positiveWordsUsed = words.filter(word => positiveWords.includes(word));
  let negativeWordsUsed = words.filter(word => negativeWords.includes(word));
